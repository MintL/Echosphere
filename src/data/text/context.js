...
export const CONTEXT_TEMPLATES = {
  priorSameEvent: [
    ...
    "Cycle {priorCycle} — same reading.",
    "Logged this in cycle {priorCycle}. Same numbers, same pattern.",
    "On record: the same event at cycle {priorCycle}.",
    "Not the first time I've flagged this. Cycle {priorCycle}.",
    "I've marked this before — cycle {priorCycle}.",
    "The entry from cycle {priorCycle} reads the same.",
    "Cycle {priorCycle} began the same way. Worth noting.",
  ],
  ...
  consecutivePattern_populationSurge: [
    ...
    "Growth uninterrupted since cycle {startCycle}.",
    "No reversal yet — {n} cycles up.",
    "Still climbing. {n} cycles without a correction.",
    "Above the previous high for {n} consecutive cycles.",
    "Each cycle higher than the last since cycle {startCycle}.",
    "The run has continued for {n} cycles.",
    "Upward since cycle {startCycle}.",
    "{n} cycles of consecutive new peaks.",
  ],
