...
OBSERVATION_POOLS['feltmoss'] = {
  ...
  understood: {
    any: [
      ...
      "The mid-canopy coverage and the grazer count read each other. I check them together now.",
      "The dark scar pattern tracks the browsing routes. I've started mapping routes from the scar shape.",
      "I've measured the bare-patch rate in three survey sections long enough to see the pattern repeat.",
      "Coverage within normal range. The shimmer pulse running. Nothing to flag.",
      "The {homeBiome} mid-canopy is the first place the grazing pressure shows. I check it early.",
      "Full coverage along the upper surfaces. The pulse is running at baseline frequency.",
      "I've been checking coverage as a reflex. It's been reliable long enough to stop questioning the habit.",
      "The grazing record in the scar tissue is the most specific behavioral data I have for the browsers.",
      "I've stopped being surprised by the coverage oscillation. It has its own rhythm.",
    ],
    high: [
