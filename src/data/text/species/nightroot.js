...
OBSERVATION_POOLS['nightroot'] = {
  ...
  understood: {
    any: [
      ...
      "I note the floor condition before I check anything else in the {homeBiome}. It tells me whether to keep reading.",
      "The floor here is the last thing to change and the first signal of what's happening upstream.",
      "A change here takes several cycles to trace back to its cause. I've learned to check both ends of the chain.",
      "I've stopped logging it separately when nothing changes. The absence of a note is the note.",
      "Coverage intact across the main survey corridors. Nothing to flag.",
      "The pale surface is what I use to read the {homeBiome}. It tells me more than anything I can see directly.",
      "I check it without expecting anything. That's the correct relationship to have with something that moves this slowly.",
      "Ivory coverage from wall to wall across the survey area. The {homeBiome} baseline is holding.",
      "Whatever drives the cycle down here — grazing pressure, deeper chemistry — it runs on its own schedule.",
      "The floor margin in the main corridors is the first place a change shows. I check it early.",
    ],
    high: [
